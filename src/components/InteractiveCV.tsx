                ...
                <div className="flex items-start justify-between flex-wrap gap-2">
                  <div>
                    <h4 className="font-mono font-semibold text-sm">
                      {isFr ? "Administrateur Réseau et Système" : "Network and System Administrator"}
                    </h4>
                    <p className="text-xs text-muted-foreground mt-1">CIVIS - Saint-Pierre, La Réunion</p>
                  </div>
                  <Badge variant="outline" className="border-primary/50 text-primary bg-primary/10 text-[10px] font-mono">
                    {isFr ? "2026 (4 mois) — Stage • En cours" : "2026 (4 months) — Internship • Current"}
                  </Badge>
                </div>
                <p className="text-xs text-muted-foreground mt-2">
                  {isFr
                    ? "Déploiement réseau (VLAN, QoS, Voice VLAN), supervision Zabbix/Grafana, centralisation des logs Graylog, VPN IPsec SD-WAN, administration système & virtualisation"
                    : "Network deployment (VLAN, QoS, Voice VLAN), Zabbix/Grafana monitoring, Graylog log centralization, IPsec VPN SD-WAN, system administration & virtualization"}
                </p>
                <div className="flex flex-wrap gap-2 mt-3">
                  <StatBadge label="Graylog" />
                  <StatBadge label="Zabbix/Grafana" />
                  <StatBadge label="Fortigate/SD-WAN" />
                  <StatBadge label="vCenter/LVM" />
                </div>
              </div>
